...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen pt-28 pb-0 bg-white flex flex-col overflow-hidden">
      <Gred />

      <div className="relative z-10 max-w-[1440px] px-8 flex-1 flex flex-col">
        <div className="max-w-[860px] py-16">
          <SectionTag>Practical AI &amp; Technology for Business</SectionTag>
          <h1 className="mt-10 text-7xl font-bold text-gray-950 leading-[1.05] tracking-tight">
          ...
          {/* Paragraph wrapper for smooth reveal */}
          <div className="overflow-hidden">
            <p
              className="mt-8 text-lg text-gray-600 leading-relaxed max-w-2xl opacity-0 animate-slide-up"
              style={{ animationDelay: '1s' }} // starts after headings
            >
          ...
          <div className="mt-12 flex items-center gap-6">
            ...
            <button className="inline-flex items-center gap-2 px-7 py-4 border border-gray-300 hover:border-gray-400 text-gray-800 font-semibold rounded-lg transition-colors bg-white/60">
